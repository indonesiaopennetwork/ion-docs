# `policies/sectors/finance/` — Finance sector policies

This folder will hold the policy IRI registry for ION's Finance
...
Empty. Policies will be added as the Finance Sector Working
Group drafts them.
