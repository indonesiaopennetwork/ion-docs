# `policies/sectors/hospitality/` — Hospitality sector policies

This folder will hold the policy IRI registry for ION's Hospitality
...
Empty. Policies will be added as the Hospitality Sector Working
Group drafts them.
