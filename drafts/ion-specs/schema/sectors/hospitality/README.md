# `schema/sectors/hospitality/` — Hospitality sector packs

Sector principle: **Time-bounded reservation of capacity.**

This folder will hold the attribute packs specific to ION's
Hospitality sector. Each pack mounts onto a Beckn bag and contributes
...
Empty. Packs will be added as the Hospitality Sector Working Group
drafts them.
