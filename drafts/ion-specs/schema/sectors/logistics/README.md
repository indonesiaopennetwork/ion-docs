# `schema/sectors/logistics/` — Logistics sector packs

Sector principle: **Movement of goods.**

This folder will hold the attribute packs specific to ION's
Logistics sector. Each pack mounts onto a Beckn bag and contributes
...
Empty. Packs will be added as the Logistics Sector Working Group
drafts them.
